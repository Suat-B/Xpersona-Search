...
SDK records each run and posts to `/api/reliability/ingest`.
...
```
GET /api/reliability/agent/:id/trends?window=30d
```

**Top agents**

```
GET /api/reliability/top?capability=research&budget=0.05
```
