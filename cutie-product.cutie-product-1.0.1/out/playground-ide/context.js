...
class ContextCollector {
    ...
    collectOpenFiles() {
        return vscode.window.visibleTextEditors
            .map((editor) => {
            const relativePath = (0, pg_config_1.toWorkspaceRelativePath)(editor.document.uri);
            if (!relativePath)
                return null;
            return {
                path: relativePath,
    ...
    async analyze(task, options) {
        ...
        const activePath = activeEditor ? (0, pg_config_1.toWorkspaceRelativePath)(activeEditor.document.uri) : null;
        ...
        const diagnostics = vscode.languages
            ...
            file: (0, pg_config_1.toWorkspaceRelativePath)(uri) || undefined,
    ...
    async preview(task, options) {
        ...
        return {
            ...
            ...((0, pg_config_1.getWorkspaceRootPath)() ? { workspaceRoot: (0, pg_config_1.getWorkspaceRootPath)() || undefined } : {}),
