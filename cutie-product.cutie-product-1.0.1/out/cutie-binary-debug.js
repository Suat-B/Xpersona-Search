...
exports.CutieBinaryDebugTracker = void 0;
exports.summarizeBinaryBuildEvent = summarizeBinaryBuildEvent;
...
class CutieBinaryDebugTracker {
    ...
    noteEvent(event) {
        ...
        this.snapshot.eventTimeline = trimList([...this.snapshot.eventTimeline, summarizeBinaryBuildEvent(event)], MAX_EVENT_TIMELINE);
    }
}
exports.CutieBinaryDebugTracker = CutieBinaryDebugTracker;
//# sourceMappingURL=cutie-binary-debug.js.map