...
exports.CUTIE_MAX_MODEL_MESSAGES = exports.CUTIE_CONTEXT_RECEIPT_WINDOW = exports.CUTIE_MAX_TOOLS_PER_BATCH = exports.CUTIE_MAX_IDENTICAL_CALLS = exports.CUTIE_MAX_WALL_CLOCK_MS = exports.CUTIE_MAX_DESKTOP_MUTATIONS = exports.CUTIE_MAX_WORKSPACE_MUTATIONS = exports.CUTIE_MAX_STEPS = void 0;
...
exports.limitCutieModelMessages = limitCutieModelMessages;
...
exports.CUTIE_MAX_MODEL_MESSAGES = 80;
...
function limitCutieModelMessages(messages, maxMessages = exports.CUTIE_MAX_MODEL_MESSAGES) {
    const normalized = messages.filter((message) => !!message && typeof message.role === "string" && typeof message.content === "string");
