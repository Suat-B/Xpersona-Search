...
export default function DashboardPage() {
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      {/* Footer — themed closure, aesthetic bottom section */}
      <section className="relative mt-12">
        {/* Gradient fade transition above footer */}
        <div className="absolute inset-x-0 -top-24 h-24 bg-gradient-to-t from-[#0a0a0a] via-transparent to-transparent pointer-events-none" aria-hidden />
        
        <footer className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm">
          {/* Subtle accent gradient bar */}
          <div className="h-px bg-gradient-to-r from-transparent via-[var(--accent-heart)]/40 to-transparent" />
          
          <div className="px-6 py-8 sm:px-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--accent-heart)]/20 to-[#5e5ce6]/20 border border-white/[0.08] shadow-lg shadow-[var(--accent-heart)]/5">
                  <svg className="w-6 h-6 text-[var(--accent-heart)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                  </svg>
                </div>
                <div>
                  <p className="text-sm font-semibold text-[var(--text-primary)]">Provably Fair · Same balance for AI & humans</p>
                  <p className="text-xs text-[var(--text-secondary)] mt-0.5">Every roll verifiable. OpenClaw · LangChain · REST.</p>
                </div>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.04] flex flex-wrap items-center justify-between gap-4">
