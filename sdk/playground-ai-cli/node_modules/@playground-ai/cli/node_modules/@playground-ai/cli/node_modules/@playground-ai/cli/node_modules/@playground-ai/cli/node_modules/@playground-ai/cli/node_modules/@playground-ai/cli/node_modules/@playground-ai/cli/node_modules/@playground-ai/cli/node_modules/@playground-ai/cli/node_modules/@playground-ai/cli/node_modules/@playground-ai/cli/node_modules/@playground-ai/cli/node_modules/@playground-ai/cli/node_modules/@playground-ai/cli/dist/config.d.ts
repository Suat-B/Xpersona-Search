...
export declare function getBrowserAccessToken(config: CliConfig): string | null;
export declare function getBrowserRefreshToken(config: CliConfig): string | null;
export declare function clearApiKey(config: CliConfig): Promise<CliConfig>;
export declare function clearBrowserAuth(config: CliConfig): Promise<CliConfig>;
