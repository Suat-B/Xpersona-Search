...
async function resolveAuth(config) {
    ...
    throw new Error("No CLI auth found. Run 'playground auth browser' (recommended) or 'playground auth set-key'.");
}
