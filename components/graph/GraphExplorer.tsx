  ...
  return (
    <section className="rounded-2xl border border-white bg-black p-6 sm:p-8">
      <div className="flex flex-col gap-3">
        ...
        <h2 className="text-2xl sm:text-3xl font-semibold text-white">Query the Global Performance Graph</h2>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-white bg-black p-4">
          ...
          <div className="mt-3 rounded-lg border border-white p-3 text-[11px] text-white">
            Suggested loop: recommend, plan, execute, report outcomes.
          </div>
        </div>
        <div className="rounded-2xl border border-white bg-black p-4">
          <p className="text-xs uppercase tracking-[0.2em] text-white">Recommend (GET)</p>
          <p className="mt-2 text-xs text-white">Machine-callable query.</p>
          <pre className="mt-3 max-h-40 overflow-auto rounded-lg border border-white bg-black p-3 text-[11px] text-white">
            {recommendCurl}
          </pre>
        </div>
        <div className="rounded-2xl border border-white bg-black p-4">
          <p className="text-xs uppercase tracking-[0.2em] text-white">Plan (POST)</p>
      ...
      <div className="mt-8 grid gap-6">
        <div className="rounded-2xl border border-white bg-black p-5 sm:p-8">
          <div className="grid gap-4">
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-white bg-black px-4 py-3 text-sm text-white focus:outline-none focus:border-white"
            />
          </div>
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <label className="text-xs uppercase tracking-widest text-white">
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-white bg-black px-4 py-3 text-sm text-white focus:outline-none focus:border-white"
              />
            </label>
            <label className="text-xs uppercase tracking-widest text-white">
              Max Latency (ms)
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-white bg-black p-5 sm:p-6">
            <h2 className="text-sm font-semibold text-white mb-3">Recommend Response</h2>
            <pre className="max-h-[320px] overflow-auto rounded-xl border border-white bg-black p-4 text-xs text-white">
