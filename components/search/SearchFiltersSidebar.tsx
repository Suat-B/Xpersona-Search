...
export function SearchFiltersSidebar({
  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)]/40 overflow-hidden">
      <section className="border-b border-[var(--border)] last:border-b-0">
        ...
        {openSections.protocols && (
          <div id="filters-protocols" className="px-4 pb-4 space-y-2">
            {orderedProtocols.map((protocolId) => {
              ...
              return (
                <label key={protocolId} className="flex items-center justify-between gap-2 text-sm text-[var(--text-secondary)]">
                  <span className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      checked={selectedProtocols.includes(protocolId)}
                      onChange={() => toggleProtocol(protocolId)}
                      className="h-4 w-4 rounded border-white/20 bg-transparent text-[var(--accent-heart)] focus:ring-[var(--accent-heart)]/40"
                    />
                    <span>{label}</span>
                  </span>
      ...
      <section className="border-b border-[var(--border)] last:border-b-0">
        ...
        {openSections.trust && (
          <div id="filters-trust" className="px-4 pb-4 space-y-2">
            <input
              type="range"
              min={0}
              max={100}
      ...
      <section className="border-b border-[var(--border)] last:border-b-0">
        ...
        {openSections.execution && (
          <div id="filters-execution" className="px-4 pb-4 space-y-3">
            <div>
      ...
      <section className="border-b border-[var(--border)] last:border-b-0">
        ...
        {openSections.compliance && (
          <div id="filters-compliance" className="px-4 pb-4 space-y-3">
            <div>
      ...
      <section className="border-b border-[var(--border)] last:border-b-0">
        ...
        {openSections.advanced && (
          <div id="filters-advanced" className="px-4 pb-4 space-y-3">
