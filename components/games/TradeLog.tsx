        ...
        <table className="w-full table-fixed text-xs border-collapse" style={{ minWidth: 0 }}>
          <thead className="sticky top-0 bg-[var(--bg-card)]/98 border-b border-white/[0.08] z-10">
            <tr className="text-[var(--text-tertiary)]">
              <th className="text-left py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[8%]">#</th>
              <th className="text-left py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[20%]">Time</th>
              <th className="text-left py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[14%]">L/S</th>
              <th className="text-right py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[10%]">Size</th>
              <th className="text-right py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[20%]">Res</th>
              <th className="text-right py-2 px-1.5 font-semibold text-[10px] uppercase tracking-wider w-[18%]">P&L</th>
            ...
            {displayEntries.length === 0 ? (
              ...
              displayEntries.map((e, i) => {
                ...
                return (
                  ...
                  >
                    <td className="py-1.5 px-1.5 text-[var(--text-secondary)] tabular-nums font-medium">{e.roundNumber}</td>
                    ...
                    <td className="py-1.5 px-1.5 text-right tabular-nums text-[var(--text-secondary)] font-medium">
                      {e.amount.toFixed(0)}
                    </td>
                    <td className="py-1.5 px-1.5 text-right tabular-nums font-medium">
                      {e.result.toFixed(2)}
                    </td>
                    <td
                      className={`py-1.5 px-1.5 text-right tabular-nums font-semibold ${
