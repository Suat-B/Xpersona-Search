...
const FORTUNES = [
  ...
  "One transaction does not define a session. Compounding does.",
  ...
  "Flat transactions sleep well. Martingale dreams big.",
  "The Kelly Criterion says: transact a fraction, not the farm.",
