  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "w-full rounded-xl px-4 py-3 font-medium text-white transition-all duration-300",
          disabled && "bg-[var(--text-tertiary)]/20 cursor-not-allowed",
          !disabled && "bg-[#30d158] hover:bg-[#30d158]/90 shadow-lg shadow-[#30d158]/20 hover:shadow-[#30d158]/30",
        )}
      >
        {loading ? (
