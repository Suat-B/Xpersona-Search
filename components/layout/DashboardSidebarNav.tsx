...
const ICONS = {
  ...
  jobs: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V6a2 2 0 012-2h4a2 2 0 012 2v1m-9 0h10a2 2 0 012 2v8a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2zm4 5h4" />
    </svg>
  ),
  deposit: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dashboard/jobs", label: "Jobs", icon: "jobs" as const, exact: false },
    ],
  },
  {
    label: "Funds",
