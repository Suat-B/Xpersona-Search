  ...
  return (
    <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4 max-w-md w-full">
      <p className="text-xs text-[var(--text-primary)] mb-2">
        Give your AI the link to https://xpersona.co/docs. Give it your API key. Done.
      </p>
      ...
      <Link href="/docs" className="mt-2 inline-block text-[10px] text-[var(--accent-heart)] hover:underline">
