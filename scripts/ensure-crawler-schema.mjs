...
CREATE UNIQUE INDEX IF NOT EXISTS "crawl_tasks_task_key_idx"
  ON "crawl_tasks" ("task_key");
CREATE INDEX IF NOT EXISTS "crawl_tasks_status_idx"
  ON "crawl_tasks" ("status");
CREATE INDEX IF NOT EXISTS "crawl_tasks_type_idx"
  ON "crawl_tasks" ("task_type");
CREATE INDEX IF NOT EXISTS "crawl_tasks_next_attempt_idx"
  ON "crawl_tasks" ("next_attempt_at");
CREATE INDEX IF NOT EXISTS "crawl_tasks_priority_idx"
  ON "crawl_tasks" ("priority");
CREATE INDEX IF NOT EXISTS "crawl_tasks_lease_owner_idx"
  ON "crawl_tasks" ("lease_owner");
CREATE INDEX IF NOT EXISTS "crawl_tasks_lease_exp_idx"
  ON "crawl_tasks" ("lease_expires_at");
CREATE INDEX IF NOT EXISTS "crawl_tasks_pending_ready_idx"
  ON "crawl_tasks" ("status", "next_attempt_at", "priority")
...
async function main() {
  ...
  try {
    ...
    console.log("ok: crawler schema ensured (frontier + task pipeline + search documents).");
  } catch (err) {
