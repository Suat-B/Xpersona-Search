...
export const ACTION_INFO: Record<ActionType, { label: string; description: string; needsValue: boolean; valueLabel?: string; defaultValue?: number }> = {
  increase_bet_percent: { label: "Increase Transaction %", description: "Increase current transaction by N%", needsValue: true, valueLabel: "Percent", defaultValue: 5 },
  decrease_bet_percent: { label: "Decrease Transaction %", description: "Decrease current transaction by N%", needsValue: true, valueLabel: "Percent", defaultValue: 5 },
  multiply_bet: { label: "Multiply Transaction", description: "Multiply current transaction by N", needsValue: true, valueLabel: "Multiplier", defaultValue: 2 },
  divide_bet: { label: "Divide Transaction", description: "Divide current transaction by N", needsValue: true, valueLabel: "Divisor", defaultValue: 2 },
  increase_bet_absolute: { label: "Increase Transaction +", description: "Add N to current transaction", needsValue: true, valueLabel: "Amount", defaultValue: 10 },
  decrease_bet_absolute: { label: "Decrease Transaction -", description: "Subtract N from current transaction", needsValue: true, valueLabel: "Amount", defaultValue: 10 },
  set_bet_absolute: { label: "Set Transaction To", description: "Set transaction to specific amount", needsValue: true, valueLabel: "Amount", defaultValue: 10 },
  set_bet_percent_of_balance: { label: "Transaction % of Balance", description: "Set transaction to N% of current balance", needsValue: true, valueLabel: "Percent", defaultValue: 1 },
  set_bet_percent_of_base: { label: "Transaction % of Base", description: "Set transaction to N% of base amount", needsValue: true, valueLabel: "Percent", defaultValue: 100 },
  reset_bet: { label: "Reset Transaction", description: "Reset transaction to base amount", needsValue: false },
  double_bet: { label: "Double Transaction", description: "Double the current transaction", needsValue: false },
  halve_bet: { label: "Halve Transaction", description: "Halve the current transaction", needsValue: false },
  triple_bet: { label: "Triple Transaction", description: "Triple the current transaction", needsValue: false },
  max_bet: { label: "Max Transaction", description: "Set to maximum allowed transaction", needsValue: false },
  min_bet: { label: "Min Transaction", description: "Set to minimum allowed transaction", needsValue: false },
  ...
  skip_next_bet: { label: "Skip Next", description: "Skip the next transaction", needsValue: false },
...
export const STRATEGY_PRESETS: { id: string; name: string; description: string; strategy: AdvancedDiceStrategy }[] = [
  {
    id: "adaptive-kelly",
    name: "Adaptive Kelly",
    description: "Adjusts transaction size based on win rate",
    strategy: {
      name: "Adaptive Kelly",
