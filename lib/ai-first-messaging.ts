...
export const AI_FIRST_MESSAGING = {
  ...
  connectAICopy: "Give your AI the link. Give it your key. Done.",
  cta: {
    human: "Play now",
  ...
  signInOrAgent: "Continue as Human to play in browser — or Continue as AI to get a key and connect.",
  guestAgentNote: "Continue as AI to get your API key. Give your AI the link and the key.",
